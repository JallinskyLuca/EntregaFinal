...
* Visualización de Productos: Los productos se cargan dinámicamente desde un archivo JSON (`productos.json`) utilizando `fetch` y se muestran en la página principal. Se incluye manejo básico de errores en la carga del JSON.
...
* Fetch API: Se utiliza para cargar de forma asíncrona los datos de los productos desde el archivo `productos.json`. Se incluye manejo básico de errores en la carga.
* SweetAlert2 (Librería Externa - Versión 11): Librería para mostrar alertas y notificaciones atractivas. Documentación: [https://sweetalert2.github.io/](https://sweetalert2.github.io/)
...
6.  *Autenticación: **RECOMENDACION REGISTRO DE USUARIO: (usuario: usuario1, constraseña: 1234, Mail: usuario@gmail.com)**
...
# Notas Adicionales
* Los datos de los productos se cargan desde el archivo `productos.json`. Puedes modificar este archivo para agregar, eliminar o editar productos.
...
* Se puede crear diferentes usuarios e iniciar sesion con cada uno 
    EJ: usuario: usuario1, constraseña: 1234, Mail: usuario@gmail.com 
        usuario: usuario2, constraseña: 1234, Mail: usuario2@gmail.com 
        usuario: usuario3, constraseña: 1234, Mail: usuario3@gmail.com 
